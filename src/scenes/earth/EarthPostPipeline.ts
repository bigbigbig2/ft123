...
import type { EarthDebugPostState } from '../EarthScene';

const TONE_MAPPING_MODES: Record<EarthDebugPostState['toneMappingMode'], ToneMappingMode> = {
...
export class EarthPostPipeline implements ScenePostPipeline {
  ...
  constructor(
    ...
    private readonly settings: EarthDebugPostState,
  ) {

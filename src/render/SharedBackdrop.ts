  ...
  constructor(opts: SharedBackdropOptions) {
    this.material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        uColor1: { value: new THREE.Color('#bdc1d8') },
        uColor2: { value: new THREE.Color('#7c818c') },
        ...
        uDotStrength: { value: 2.0 },
        uBlueNoiseStrength: { value: 0.042 },
        uCenterGlowStrength: { value: 0.37 },
      },
